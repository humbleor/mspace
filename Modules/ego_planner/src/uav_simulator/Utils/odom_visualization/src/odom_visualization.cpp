...
ros::Publisher pathPub;ros::Publisher goal_path_pub;
...
{
  //cout<<"1111111111111111111111zzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzz"<<endl;
  ...
  // Path
    ...
    path_id+=1;path_id=path_id%100000;
   // cout<<path_id<<"zzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzz"<<endl;
    sphere.id = path_id;

    sphere.pose.orientation.w = 0.05;
    sphere.color.r = 0;
    sphere.color.g = 1;
    sphere.color.b = 0;
    sphere.color.a = 1;
    double spherescale = 0.15;
    sphere.scale.x = spherescale;
    sphere.scale.y = spherescale;
    sphere.scale.z = spherescale;
    sphere.pose.position.x = pose(0);
    sphere.pose.position.y = pose(1);
    sphere.pose.position.z = pose(2);

    goal_path_pub.publish(sphere);
...
int main(int argc, char** argv)
{
  ...
  goal_path_pub    = n.advertise<visualization_msgs::Marker>("maker_path",   100, true);//bnb
